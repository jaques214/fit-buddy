...
public class Weather implements Serializable {
    ...
    public Weather(Coor coord, WeatherDetails[] weather, String base, Main main, int visibility, Wind wind, Cloud clouds, int dt, Sys sys, int timezone, int id, String name, int cod) {
        this.coord = coord;
